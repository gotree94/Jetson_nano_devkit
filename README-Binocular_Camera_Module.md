...
- [Specifications](#specifications)
  - [Camera (Sony IMX219)](#camera-sony-imx219)
  - [ICM20948 9-Axis IMU](#icm20948-9-axis-imu)
    - [Accelerometer](#accelerometer)
    - [Gyroscope](#gyroscope)
    - [Magnetometer](#magnetometer)
  - [Physical](#physical)
- [Working with Jetson Nano](#working-with-jetson-nano)
  - [Hardware Connection](#hardware-connection)
  - [Software Setup](#software-setup)
  - [Fix Red-Tinted Image](#fix-red-tinted-image)
- [How to Use the IMU Sensor (ICM20948)](#how-to-use-the-imu-sensor-icm20948)
  - [Test the IMU](#test-the-imu)
- [Working with Raspberry Pi 5 (Compute Module)](#working-with-raspberry-pi-5-compute-module)
- [libcamera Usage (Bullseye and earlier)](#libcamera-usage-bullseye-and-earlier)
  - [Enabling the Camera](#enabling-the-camera)
  - [libcamera Commands Summary](#libcamera-commands-summary)
  - [libcamera-hello](#libcamera-hello)
    - [Tuning File](#tuning-file)
    - [Preview Window Info](#preview-window-info)
  - [libcamera-jpeg](#libcamera-jpeg)
    - [Exposure Control](#exposure-control)
  - [libcamera-still](#libcamera-still)
    - [Encoder (Output Formats)](#encoder-output-formats)
    - [Raw Image Capture (DNG)](#raw-image-capture-dng)
    - [Long Exposure](#long-exposure)
  - [libcamera-vid](#libcamera-vid)
    - [Encoder (MJPEG / YUV420)](#encoder-mjpeg--yuv420)
    - [UDP Streaming (Server)](#udp-streaming-server)
    - [TCP Streaming (Server)](#tcp-streaming-server)
    - [RTSP Streaming (Server)](#rtsp-streaming-server)
    - [High Frame Rate Mode (>60fps)](#high-frame-rate-mode-60fps)
  - [libcamera-raw](#libcamera-raw)
  - [Common libcamera Command Options](#common-libcamera-command-options)
    - [AWB Modes](#awb-modes)
  - [Still Image Shooting Options (libcamera-still)](#still-image-shooting-options-libcamera-still)
  - [Video Recording Options (libcamera-vid)](#video-recording-options-libcamera-vid)
- [RPicam Usage (Bookworm and later)](#rpicam-usage-bookworm-and-later)
  - [Enable Cameras](#enable-cameras)
  - [rpicam-hello](#rpicam-hello)
    - [Tuning File](#tuning-file-1)
  - [rpicam-jpeg](#rpicam-jpeg)
    - [Exposure Control](#exposure-control-1)
  - [rpicam-still](#rpicam-still)
    - [Encoder](#encoder)
    - [Raw Image Capture](#raw-image-capture)
    - [Ultra-Long Exposure](#ultra-long-exposure)
  - [rpicam-vid](#rpicam-vid)
    - [Encoder](#encoder-1)
    - [High Frame Rate](#high-frame-rate)
    - [Libav Integration](#libav-integration)
    - [UDP Streaming (Server)](#udp-streaming-server-1)
    - [TCP Streaming (Server)](#tcp-streaming-server-1)
    - [RTSP Streaming (Server)](#rtsp-streaming-server-1)
  - [rpicam-raw](#rpicam-raw)
  - [rpicam-detect](#rpicam-detect)
  - [RPicam Parameter Reference](#rpicam-parameter-reference)
- [Resources](#resources)
  - [Demo Code](#demo-code)
